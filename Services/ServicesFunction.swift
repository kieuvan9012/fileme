...
enum APIFunction : String
{
    ...
    case bookUserUpdate     = "book/user/update"
    ...
    case bookTradingDetail = "book/trading/detail"
    case bookDelete = "book/delete"
    case bookUserDelete = "book/user/delete"
