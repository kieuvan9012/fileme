...
class FileViewController: MasterViewController, UITableViewDelegate, UITableViewDataSource, UIDocumentMenuDelegate, AddFolderViewDelegate, UIDocumentPickerDelegate
{
